...
export default function Title() {
  ...
  return (
    ...
    <nav className="bg-transparent border-gray-200 px-4 lg:px-6 py-2.5 flex-wrap justify-between items-center">
      ...
      <div className="hidden justify-between items-center w-full lg:flex lg:w-50 " >
        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 ml-40">
