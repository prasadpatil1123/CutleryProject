...
const AboutUs = () => {
  return (
    <div className="about-us">
      <h1>About Rotary Cutlery Distribution Management Application</h1>
      <p>
        The Rotary Cutlery Distribution Management Application is a web application designed to help Rotary Clubs manage their cutlery distribution programs. The application allows clubs to track their inventory, manage their volunteers, and generate reports.
      </p>
